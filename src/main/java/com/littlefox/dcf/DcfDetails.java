 ...
 * the {@link Dcf} algorithm.
 */
class DcfDetails {

    public static Collector<Transaction, DcfDetails, DcfDetails> collector() {
        return Collector.of(
            DcfDetails::new,
            DcfDetails::accumulate,
            DcfDetails::combine,
    ...
    public DcfDetails combine(final DcfDetails other) {
